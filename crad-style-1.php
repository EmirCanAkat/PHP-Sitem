	...
	<div class="bg-img color-white main-container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="nav nav-pills mx-auto" id="pills-tab" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link nav-menu active" id="home-tab" data-toggle="pill" href="#home" role="tab" aria-controls="home" aria-selected="true">Anasayfa</a>
							</li>

							<?php if ($dataSet->show_aboutpage) { ?>
							<li class="nav-item" role="presentation">
								<a class="nav-link nav-menu" id="about-page-tab" data-toggle="pill" href="#about-page" role="tab" aria-controls="about-page" aria-selected="false">Hakkımızda</a>
							</li>
							<?php } ?>

							<?php if ($dataSet->show_contactpage) { ?>
							<li class="nav-item" role="presentation">
								<a class="nav-link nav-menu" id="contact-page-tab" data-toggle="pill" href="#contact-page" role="tab" aria-controls="contact-page" aria-selected="false">İletişim</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link nav-menu" id="contact-page-tab" data-toggle="pill" href="#contact-page" role="tab" aria-controls="contact-page" aria-selected="false">Giriş</a>
							</li>
							<?php } ?>
						</ul>
		...
		<div class="tab-content" id="home-tab">
			<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
				...
				<div id="main-content-home" class="xs-no-positioning fixed fixed-middle">
					...
					<div class="container">
						<div class="row">
							<div class="col-12">
								<div class="title">
									<p class="small-title"><?php echo strip_tags($dataSet->home_subtitle); ?></p>
									<span class="main-title"><?php echo strip_tags($dataSet->home_title); ?></span>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="countdown-timer" id="countdown-boxes">
										<ul class="list-inline count-down-list text-center">
											<li id="years">
												...
												<span class="counter-time-title">Yıl</span>
											</li>
											<li id="months">
												<span class="months"></span>
												<span class="counter-time-title">Hafta</span>
											</li>
											<li id="days">
												<span class="days"></span>
												<span class="counter-time-title">Gün</span>
											</li>
											<li id="hours">
												<span class="hours"></span>
												<span class="counter-time-title">Saat</span>
											</li>
											<li id="minutes">
												<span class="minutes"></span>
												<span class="counter-time-title">Dakika</span>
											</li>
											<li id="seconds">
												<span class="seconds"></span>
												<span class="counter-time-title">Saniye</span>
											</li>
										</ul>
									</div>

									<h2 class="expired-text text-center hidden"><?php echo strip_tags($dataSet->expired_text); ?></h2>
				...
				<!-- FOOTER PART START-->
				<div id="footer" class="fixed fixed-bottom xs-no-positioning main-footer">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="subscribe-form pb-3">
									<form class="form-inline subs_form" method="post">
										<input type="email" name="email" class="form-control btn-rounded" placeholder="<?php echo strip_tags($dataSet->subs_placeholder_txt); ?>" required>
			...
			<?php if ($dataSet->show_aboutpage) { ?>
			<div class="tab-pane fade" id="about-page" role="tabpanel" aria-labelledby="about-page-tab">
				<!-- BODY CONTENT PART START -->
			...
			<?php if ($dataSet->show_contactpage) { ?>
			<div class="tab-pane fade" id="contact-page" role="tabpanel" aria-labelledby="contact-page-tab">
				<!-- BODY CONTENT PART START -->
